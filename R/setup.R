...
processParams <- function(file,pkgname="Rngsutils",verbose=FALSE){
...
if(FALSE){
 # .onAttach <- function(libname, pkgname){
    #   params <- try(processParams(file.path(libname, pkgname, "files","default.params"), 
    #                               pkgname,verbose=FALSE))
#  }
